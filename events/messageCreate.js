...
module.exports = {
    ...
    run: async (client, message) => {
        ...
        if (bannedUsers.bannedIDs.includes(message.author.id)) {
            message.author.send('You have been banned from Netcord. If you think you have been unrightfully banned, you can appeal this in our ban appeal server: Invite not available yet')
                .catch(console.error);
            return;
        }
